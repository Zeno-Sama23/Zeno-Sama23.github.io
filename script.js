...
const translations = {
  fr: {
    ...
    'projects-roadmap': 'En préparation · Cloud Security Posture Automation · Terraform Secure Azure Baseline · Cloud-Native Detection Lab & Honeypot — AWS',
  ...
  en: {
    ...
    'projects-roadmap': 'In preparation · Cloud Security Posture Automation · Terraform Secure Azure Baseline · Cloud-Native Detection Lab & Honeypot — AWS',
